...
def main(caida_dataset_date, ground_truth_filename, simulator_version_folder, output_filename):
    ...
    ground_truth_paths = get_ground_truth_paths(ground_truth_filename)
...
if __name__ == "__main__":
    ...
    ground_truth_filename = 'output/merged_routing_tables/all_observed_anycast_prefixes_and_one_random_as_path_per_prefix_selective_announcements_only.json'
    ...
    output_filename = "output/__simulator_sigmetrics_2019__v1/all_anycast_ASes_simulated_paths_selective_announcements_only.json"
